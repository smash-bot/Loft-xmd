...
async function helpCommand(sock, chatId, message) {
    try {
        // Tuma picha na caption yenye jedwali
...
─────────────`
        ...
        // Tuma button menu chini
        await sock.sendMessage(chatId, {
            text: "*Chagua huduma nyingine hapa chini👇*",
            buttons: [
                { buttonId: '.owner', buttonText: { displayText: 'Owner' }, type: 1 },
                { buttonId: '.repo', buttonText: { displayText: 'Repo' }, type: 1 },
                { buttonId: '.menu', buttonText: { displayText: 'All Command' }, type: 1 }
            ],
        ...
        await sock.sendMessage(chatId, { text: "Samahani, kuna tatizo kwenye menu kuu." });
    }
}
